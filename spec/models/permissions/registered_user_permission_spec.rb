...
module Permissions
  describe RegisteredUserPermission do
    ...
    describe 'caller and target_user are the same user' do
      ...
      it 'registered user permissions for leaderboards' do 
      ...
      it 'registered user permissions for comments' do 
      ...
      it 'registered user permissions for highfives' do 
      ...
      it 'registered user permissions for notifications' do 
