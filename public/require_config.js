...
define([], function() {
  return require.config({
    packages: ['core', 'game/levels/_base', 'game/levels/reaction_time_disc', 'game/levels/rank_images', 'game/levels/circle_size', 'game/levels/person_fill', 'game/levels/proximity_takes_turns', 'game/levels/circle_proximity', 'game/levels/alex_trebek', 'game/levels/emotions_circles', 'game/levels/snoozer', 'game/levels/interest_picker', 'dashboard/widgets/base', 'dashboard/widgets/lister', 'ui_widgets/formation'],
    paths: {
